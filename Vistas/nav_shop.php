      ...
      <?php while($row=$resultado->fetch_array()){?>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="<?PHP echo SERVERURL;?>1/con/<?php echo $row2['c_id']?>"><?php echo $row2['c_nmb']?></a></li>
            <?php }?>
            <li><a class="dropdown-item"href="<?php echo SERVERURL;?>1/dep/<?php echo $row['dw_id']?>">VER TODO</a></li>
          </ul>
        </li>
        <?php }?>
        <li class="nav-item dropdown">
